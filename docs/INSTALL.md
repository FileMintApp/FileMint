...
2. 0.5.6 使用 Developer ID 签名，已通过 Apple 公证并附加（stapled）票据。
...
then open FileMint from Applications. Version 0.5.6 is Developer ID signed,
...
macOS 可能要求管理员授权。旧版用户需要手动安装一次 0.5.6。
