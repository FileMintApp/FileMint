...
plutil -insert CFBundleShortVersionString -string 0.5.9 "$DESIGN_APP/Contents/Info.plist"
plutil -insert CFBundleVersion -string 17 "$DESIGN_APP/Contents/Info.plist"
