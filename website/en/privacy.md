...
FileMint creates files locally and offline. It does not require an account or collect usage analytics.
...
Only the main app accesses GitHub when you explicitly check for or download an update. The Finder extension stays offline.
